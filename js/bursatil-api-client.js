...
function setValues(value, intElement, decElement) {
    ...
    document.querySelector(decElement).innerHTML = removeFirstDigit(decimalValue.toFixed(2))
    
}


function removeFirstDigit(digits) {
    const digitsArray = digits.toString().split('');
    digitsArray.splice(0,2);
